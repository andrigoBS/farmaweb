...
const Home = (props) => {
    let urlUser = FarmaStorage.user.isNull()? "/signUp" : "/";
                ...
                <ListGroup.Item>
                    <Jumbotron fluid>
                        <Container className="ml-5">
                            ...
                            <p>
                                <h4> Comece Já: </h4>
                                <Button href={urlUser} className="buttonsClass mr-1">Sou usuario</Button>
                                <Button href="/pharmacy" className="buttonsClass">Sou uma Farmácia</Button>
                            </p>
                        </Container>
                    </Jumbotron>
                </ListGroup.Item>
